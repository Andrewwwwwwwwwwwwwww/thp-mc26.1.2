...
#send particle
$execute rotated $(other_angle) $(particle_angle_current) run particle $(particle_type) ~ ~ ~ ^ ^ ^1000000000 $(speed) 0 $(force)
...
#recursion
function roguecraft:particles/ring/run_vertical with storage roguecraft:master particles