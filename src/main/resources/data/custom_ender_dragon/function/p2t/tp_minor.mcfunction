execute at @e[type=minecraft:ender_dragon] run tp @e[type=minecraft:ender_dragon] @e[type=minecraft:marker,tag=phase_2t,distance=1..,sort=random,limit=1]
execute at @e[type=minecraft:ender_dragon] run summon minecraft:lightning_bolt
data modify entity @e[type=minecraft:ender_dragon,limit=1] DragonPhase set value 5
